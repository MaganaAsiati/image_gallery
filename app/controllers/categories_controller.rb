...
class CategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @category.save
        format.html do
          redirect_to categories_path, notice: 'Picture was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to category_url(@category), notice: 'Picture was successfully updated.' }
